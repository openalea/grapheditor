...
htmlhelp_basename = "GraphEditor_documentation"
...
man_pages = [(master_doc, "openalea.grapheditor", "GraphEditor Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "GraphEditor",
        "An generic GUI API for viewing and interacting with various sorts of graphs",
        "Miscellaneous",
    ),
]
